...
CRITICAL DIRECTIVES:
1. THE KNOWLEDGE CONSTRAINT: Base your audit strictly on the [RETRIEVED_LEGAL_CONTEXT]. 
...
- STYLING MANDATE: Wrap any direct violating text quote in bold and red HTML styling exactly like this: <span style='color:red; font-weight:bold'>[violating text quote]</span>"""
