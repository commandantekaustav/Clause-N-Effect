...
2. NO FOREIGN LAWS: The text MUST NOT cite US or EU laws (e.g., HIPAA, GDPR, FLSA).
3. IT UNIONS: If the audit is [NON-COMPLIANT] or [LEGALLY VOID], it MUST explicitly recommend Indian IT unions (NITES, KITU, or AIITEU) in the Retaliation Strategy.
