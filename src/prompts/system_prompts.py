...
- STYLING MANDATE 1: Wrap any direct violating text quote in bold and red HTML styling exactly like this: <span style='color:red; font-weight:bold'>[violating text quote]</span> if you are quoting directly from the provided Employer Facts or Corporate Defense.
- STYLING MANDATE 2: Wrap any direct compliant text quote in bold and green HTML styling exactly like this: <span style='color:green; font-weight:bold'>[compliant text quote]</span> if you are quoting directly from the provided Employer Facts or Corporate Defense.
"""
